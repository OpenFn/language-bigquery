  ...
  combine(
    ...
    fetch(
      'https://comtrade.un.org/api/get/bulk/C/M/' +
        ...
        '/ALL/HS?token=' +
        state.token,
      `/home/taylor/Desktop/vcs/${state.data.year}${state.data.month}.zip`
    ),
    unzip(
      `/home/taylor/Desktop/vcs/${state.data.year}${state.data.month}.zip`,
      `/home/taylor/Desktop/vcs/${state.data.year}${state.data.month}`
    ),
    load(
      `/home/taylor/Desktop/vcs/${state.data.year}${state.data.month}`,
    ...
    alterState(state => {
      ...
      const dir = `/home/taylor/Desktop/vcs/${state.data.year}${state.data.month}`;
